  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col gap-6">
      ...
      <div className="bg-palco-800 border border-palco-700 rounded-2xl p-6 sm:p-8 text-center">
        ...
        <h2 className="titulo-jogo text-xl sm:text-2xl mt-2 leading-snug">{afirmacao.afirmacao}</h2>
      </div>
        ...
        {[
          ...
          return (
            <button
              ...
              className={`py-6 rounded-xl border titulo-jogo text-lg transition-colors
